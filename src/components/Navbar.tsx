      ...
      <div className="relative bg-white rounded-2xl border border-gray-200 shadow-2xl max-w-lg w-full max-h-[92vh] overflow-y-auto">
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 gap-3 mb-5">
            {[
              { icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#D9782D" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>, title: "Earn Referral Incentives", desc: "Get paid 10K+ or even percentage-based rewards when your referred candidates are successfully placed." },
              ...
              { icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#D9782D" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>, title: "Trusted Partner Ecosystem", desc: "Work with a dedicated team that supports you with structured workflows and Growth." },
            ].map((b) => (
