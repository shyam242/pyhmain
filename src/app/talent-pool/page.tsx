...
export default function TalentPoolPage() {
  return (
    <div className="min-h-screen text-white bg-[#050B2C] relative overflow-hidden">
      ...
      {/* ambient background glow, shared visual language across recruiter tools */}
      <div className="pointer-events-none fixed inset-0 -z-10">
        <div className="absolute inset-0 bg-gradient-to-b from-[#0A1442] via-[#050B2C] to-[#050B2C]" />
        <div className="absolute -top-32 -left-32 w-[420px] h-[420px] rounded-full bg-[#D9782D]/20 blur-[120px]" />
        <div className="absolute top-[40%] -right-40 w-[480px] h-[480px] rounded-full bg-[#5B9BFF]/10 blur-[140px]" />
        <div
        ...
        <div className="max-w-6xl mx-auto px-4 py-12 lg:py-14">
          <div className="grid lg:grid-cols-[1.05fr_0.95fr] gap-10 lg:gap-14 items-center">
            ...
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-extrabold leading-[1.12] mb-4 text-white">
            ...
            <div className="relative rounded-2xl overflow-hidden h-[320px] sm:h-[380px] lg:h-[440px] bg-white/[0.04] border border-white/10 backdrop-blur-sm">
              ...
              {heroNodes.map((n) => (
                <div
                  key={`blob-${n.label}`}
                  className="absolute w-32 h-32 rounded-full blur-3xl opacity-25 pointer-events-none"
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                <div className="relative flex items-center justify-center">
                  ...
                  <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-[#0A1442] border border-white/10 flex flex-col items-center justify-center text-white shadow-lg">
              ...
              {heroNodes.map((n, i) => (
                ...
                >
                  <div
                    className="bg-[#0A1442]/90 backdrop-blur-sm rounded-xl shadow-md px-2.5 py-2 sm:px-3 sm:py-2.5 flex items-center gap-2 border max-w-[140px] sm:max-w-[160px]"
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      <p className="text-[11px] sm:text-xs font-bold text-white leading-tight truncate">{n.label}</p>
                      <p className="text-[9px] sm:text-[10px] text-white/50 leading-tight truncate">{n.example}</p>
                    </div>
                  </div>
                </div>
              ))}
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-12 items-start">
            ...
            <div className="lg:w-[42%] rounded-2xl overflow-hidden border border-white/10 relative">
              <div className="absolute inset-0 bg-gradient-to-t from-[#050B2C] via-transparent to-transparent z-10 opacity-70" />
              <Image
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="mb-10">
            <h2 className="text-2xl md:text-3xl font-bold text-white">Explore talent across every function</h2>
            <p className="text-white/55 text-sm mt-2">Roles across every domain, curated for your hiring needs.</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
            {functions.map((fn) => (
              <div key={fn.label} className="bg-white/[0.04] backdrop-blur-sm rounded-xl border border-white/10 p-5 hover:border-[#D9782D]/40 hover:bg-white/[0.06] transition">
                <div className="w-9 h-9 rounded-lg flex items-center justify-center mb-3" style={{ background: `${fn.color}22` }}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke={fn.color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">{fn.icon}</svg>
                </div>
                <h3 className="font-bold text-white mb-2.5">{fn.label}</h3>
